...
const getErrorMessage = (errorCode) => {
    ...
    if (process.env.NODE_ENV === 'development' && errorCode !== 'authentication_failed') {
...
const RegisterPage = () => {
    ...
    useEffect(() => {
        ...
        if (errorParam) {
            ...
            const debugInfo = process.env.NODE_ENV === 'development' ? ` (Code: ${decodeURIComponent(errorParam)})` : '';
